...
void insertData(){
	strcpy(kokomi.name, "Kokomi"); // 42k hp, 1.3k atk | sig, 4p ohc, HP/Hydro/HB, 10/10/10
	kokomi.HP = 13471 * (1 + 49.6/100 + 46.6/100 + 0.496 + 25.0/100) + 4780 + 1523.64; // base + sig + hp sands
																				// substat + hydro reso
	kokomi.ATK = (234 + 608) * (1 + 0.0992) + 311 + 99.24; // base + sig + substat
	kokomi.ER = 1 + 0.3306; // base + substats
	...
	strcpy(yelan.name, "Yelan"); // 33k hp, 161.5 cv | slingshot, 4p eosf, HP/Hydro/Crit, 1/9/10 
	yelan.HP = 14450 * (1 + 46.6/100 + 0.2976 + 25.0/100 + 12.0/100) + 4780 + 507.88; // base + hp sands + substat
																			// hydro reso + 2-element a1 passive
	yelan.ER = 100.0/100 + 20.0/100 + 0.1653; // 2p eosf + substat
	yelan.DMGBonus = 46.6/100.0; // hydro gob
	yelan.critRate = 5/100.0 + 19.2/100.0 + 31.2/100 + 0.2979; // base + ascension + slingshot + substat
	yelanBurstDMGBonus = 25.0/100 * yelan.ER;
	yelan.critDMG = 50/100.0 + 62.2/100 + 0.662; // base + cd circlet + substat
	...
	furina.HP = 15307 * (1 + 46.6/100 + 46.6/100 + 25.0/100 + 0.3968) + 4780 + 507.88; // base + hp sands + hp gob + hydro reso + substat
	furina.ER = 1 + 0.2755;
	...
	furina.critDMG = 50/100.0 + 62.2/100 + 0.1986 + 46.9/100; // base + cd circlet + substat + hod
