...
void insertData(){
	...
	cyno.EM = 187 + 63; // em sands + substat + dendro resonance
	...
	nahida.ATK = (299 + 510) * (1 + 16.4/100.0) + 311; // base + sig + substat
	nahida.EM = 115.2 + 265 + 187 + 187 + 50 + 40 + 16; // ascension + sig + em sands + em gob + dendro resonance + substat
	...
	baizhu.EM = 35 + 50; // dendro resonance
...
void cynoHyperbloom(){
	cyno.damage += 3 * 1446.85 * (1 + (16.0 * cyno.EM)/(2000.0 + cyno.EM) + 40.0/100 + baizhuBloomBuff) * dendroRes * enemyDef;
	totalDamage += 3 * 1446.85 * (1 + (16.0 * cyno.EM)/(2000.0 + cyno.EM) + 40.0/100 + baizhuBloomBuff) * dendroRes * enemyDef;
}
